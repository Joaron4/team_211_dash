...
# notas de la version: 4 de julio 2022, tal cual como esta no funciona la parte del mapa
# se muestra el dropdown, se muestra el espacio del grafico, pero la funcion de actualizar grafico no funciona
